...
import 'package:ajb1/core/usecases/get_cities.dart';
...
import 'package:ajb1/features/order/domain/usecases/delete_order.dart';
import 'package:ajb1/features/order/presentation/blocs/order_bloc.dart';
import 'package:ajb1/features/order/presentation/pages/order_details_page.dart';
...
import 'package:ajb1/core/datasources/concrete_core_remote_data_source.dart';
...
import 'package:ajb1/features/order/data/models/order_detaill.dart';
import 'package:ajb1/features/order/domain/entities/general_order_item_entity.dart';
import 'package:dio/dio.dart';
...
class _ItemOrderWidgetState extends State<ItemOrderWidget> {
  ...
  void initState() {
    ...
    _getCities(0);
    print(
        "order status is ===================================${widget.orderItem!.status}");
  }
                                      ...
                                      onTap: () {
                                        showDialog(
                                          ...
                                          builder: (ctx) => ConfirmDialog(
                                            ...
                                            confirmMessage: Translations.of(
                                                    context)
                                                .translate(
